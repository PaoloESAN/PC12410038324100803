...
using PC12410038324100803.CORE.infrastructure.Data;
...
namespace PC12410038324100803.Controllers
{
    ...
    {
        private readonly CORE.infrastructure.Data.DbContext _context;

        public TipoServiciosController(CORE.infrastructure.Data.DbContext context)
        {
            _context = context;
        }
